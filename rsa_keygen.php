...
function Generate() {
        echo"<i>Keys:</i><br>";
        do {
                list ($n, $e, $d) = generate_keys();
                if ($test = new RSA($n,$e,$d)) $result = true;
                else $result = false;
        } while (!$result);
        echo "Here is your key pair to use in your RSA application:<br>\n";
        echo "Modulo = $n;<br>\n";
        echo "Public part = $e;<br>\n";
        echo "Private part = $d;<br>\n";
}
Generate();
?>
